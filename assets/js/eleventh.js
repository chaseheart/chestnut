function TiMu(){
	...
	// 答案
	var right = {"0":3,"1":2,"2":4,"3":1,"4":2,"5":3,"6":2,"7":1,"8":3,"9":5}
	var strRight = {"9":"sunset"}
	...
	$(".submit").bind("click",function(){
		...
		$(".error").parent().append("<span class='blankAnswer'>(sunset)</span>")
	});
}
...
var data1 =[ {
             ...
             "id" : "5",  
             "title": "Here's a list of my top CD ______.这里是我认为最值得推荐的CD清单。",  
             ...
             "id" : "6",  
             "title": "How well does Chestnut ______ the lessons? 🌰对课程组织安排得如何?",  
             ...
             "id" : "9",  
             "title": "He was _____ just outside the penalty area. 他就在罚球区外被对方抢断。",  
